...
var promptUser = function (jsonFiles) {
  return new Promise(function (resolve, reject) {
    ...
    jsonFiles.forEach(function (file, index) {
      return console.log("".concat(index + 1, ". ").concat(file))
    })
...
var gameLoop = function (dungeon) {
  return __awaiter(void 0, void 0, void 0, function () {
    var inputToGame, rl, prompt, out, welcome, input
...
var app = function () {
  return readJsonFilesDirectory()
    ...
    .then(loadJsonFile)
    .then(function (x) {
      return (0, parseDungeon_1.parseDungeon)(x)
    })
    .then(printDungeon)
    .then(gameLoop)
    ["catch"](function (err) {
